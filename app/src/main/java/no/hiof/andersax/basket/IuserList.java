...
public interface IuserList {
    ...
    public void addSharedList(String listname , String description, ArrayList<String> userEmails, ArrayList<ListItem> items);
    public void addPrivateList( String listname , String description, String owner, ArrayList<ListItem> items);
